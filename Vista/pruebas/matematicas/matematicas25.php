...
<div id="contMat" style="height:540px;">
    <div id="contMat2">
        ...
        <form style="text-align:center;">
            <div class="contPr2"><pre>1) 6-3                                            16  <input type="number"></pre></div><br>
            <div class="contPr2"><pre>2) 12-6                                          3    <input type="number"></pre></div><br>
            <div class="contPr2"><pre>3) 34/2                                          14   <input type="number"></pre></div><br>
            <div class="contPr2"><pre>4) (20-11)+5                                  6    <input type="number"></pre></div><br>
            <div class="contPr2"><pre>5) (16/4)x(16/4)                             4    <input type="number"></pre></div><br>
            <div class="contPr2"><pre>6) (2x1)x2                                      17  <input type="number"></pre></div><br>
