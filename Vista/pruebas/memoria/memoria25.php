...
<div id="contmem">
    <div>
        ...
        <p>Concéntrate en las imágenes que se muestran a continuación, ten en cuenta sus características y memorízalas. Tan pronto te sientas preparado(a) pasa a la siguiente hoja. </p><br>
        <img src="../imagenes/memoria25.png"><br><br>
        <a href="memoria25b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
