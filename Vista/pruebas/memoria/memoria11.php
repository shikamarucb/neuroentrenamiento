...
<div id="contmem">
    <div>
        ...
        <p>Durante algunos minutos, observa con atención las siguientes palabras; memorízalas y tan pronto te sientas preparado(a) pasa a la siguiente hoja.</p><br>
        <img src="../imagenes/memoria11.png"><br><br>
        <a href="memoria11b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
