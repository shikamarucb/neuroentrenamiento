...
<div id="contmem" style="height:450px;">
    <div>
        <h1>¡PRUEBA TU MEMORIA! </h1><br><br>
        <p>A continuación se presenta un listado de palabras, memorízalas y tan pronto te sientas preparado(a) pasa a la siguiente página. </p><br>
        <img src="../imagenes/memoria44.png"><br><br>
        <a href="memoria44b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
