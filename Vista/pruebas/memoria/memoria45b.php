...
<div id="contmem">
    <div><br><br>
        <p>En las siguientes casillas pon el número correspondiente a la ubicación anterior. Recuerda, no debes mirar la página anterior.  </p><br><br><br>

        <form action="../../../Controlador/pruebas/memoriaControlador.php?value=memoria45" method="POST" autocomplete="off">
            <div>
