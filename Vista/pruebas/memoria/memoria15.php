<?php
    ...
    if($permiso->verificarUser()){ 
      if($permiso->accederPruebas("memoria", "15")){ 
...
<div id="contmem">
    <div>
        <h1>¡RETA TU MEMORIA! </h1><br><br>
        <p>A continuación se presentan algunos enunciados, memorízalos y tan pronto te sientas preparado(a) pasa a la siguiente hoja.</p><br>
        <img src="../imagenes/memoria15.png"><br><br>
        <a href="memoria15b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
