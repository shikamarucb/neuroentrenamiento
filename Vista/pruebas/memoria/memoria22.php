...
<div id="contmem">
    <div>
        ...
        <p>A continuación encuentras una serie de números a los cuales les corresponde un color, observa la imagen cuidadosamente y memorízalos. Tan pronto te sientas preparado(a) pasa a la siguiente hoja. </p><br>
        <img src="../imagenes/memoria22.png"><br><br>
        <a href="memoria22b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
