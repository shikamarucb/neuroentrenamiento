<?php
    ...
    if($permiso->verificarUser()){ 
      if($permiso->accederPruebas("memoria", "13")){ 
...
<div id="contmem">
    <div>
        ...
        <p>Observa con atención las siguientes palabras, memorízalas y tan pronto como te sientas preparado(a) pasa a la siguiente hoja.</p><br>
        <img src="../imagenes/memoria13.png"><br><br>
        <a href="memoria13b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
