<?php
    ...
    if($permiso->verificarUser()){ 
      if($permiso->accederPruebas("memoria", "43")){ 
...
<div id="contmem" style="height:380px;">
    <div>
        ...
        <p>Observa las figuras y los números que se presentan en el cuadro inferior, memorízalos y tan pronto te sientas preparado(a) pasa a la siguiente hoja. </p><br>
        <img src="../imagenes/memoria43.png"><br><br>
        <a href="memoria43b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
