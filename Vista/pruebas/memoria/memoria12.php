...
<div id="contmem">
    <div>
        ...
        <p>Observa detenidamente las imágenes por algunos minutos y memorízalas. Tan pronto como te sientas preparado(a) pasa a la siguiente hoja. </p><br>
        <img src="../imagenes/memoria12a.png">
        <img src="../imagenes/memoria12b.png"><br><br>
        <a href="memoria12b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
