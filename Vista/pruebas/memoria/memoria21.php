...
<div id="contmem">
    <div>
        ...
        <p>A continuación encontrarás una serie de imágenes. Observarlas detenidamente y memorízalas. Cuando te sientas preparado(a) pasa a la siguiente hoja. </p><br>
        <img src="../imagenes/memoria21.png"><br><br>
        <a href="memoria21b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
