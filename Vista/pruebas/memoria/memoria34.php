<?php
    ...
    if($permiso->verificarUser()){ 
      if($permiso->accederPruebas("memoria", "34")){ 
...
<div id="contmem">
    <div>
        ...
        <p>A continuación se presentarán los números del 1 a 9 en diferente orden. Memoriza el lugar y su ubicación por algunos minutos. Cuando te sientas preparado(a) pasa a la siguiente hoja. </p><br>
        <img src="../imagenes/memoria34.png"><br><br>
        <a href="memoria34b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
