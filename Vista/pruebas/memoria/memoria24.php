<?php
    ...
    if($permiso->verificarUser()){ 
      if($permiso->accederPruebas("memoria", "24")){ 
...
<div id="contmem">
    <div>
        ...
        <p>A continuación encontrarás tres filas de palabras. Memorízalas y tan pronto te sientas preparado(a) pasa a la siguiente página. </p><br>
        <img src="../imagenes/memoria24.png"><br><br>
        <a href="memoria24b.php">Siguiente</a>
    </div>
</div>
<footer>
    <div id="footerP">
