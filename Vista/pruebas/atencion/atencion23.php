...
<div id="contAten" style="height:450px;">
    <div id="contAten2">
        ...
        <form id="formA2">
            <h1><pre>1) 0         33         66         99 </pre></h1><input type="text"><br>
            <h1><pre>2) 60         90         120         150 </pre></h1><input type="text"><br>
            <h1><pre>3) 380         340         300         260 </pre></h1><input type="text"><br>
            <h1><pre>4) 50         150         250         350 </pre></h1><input type="text"><br><br>
